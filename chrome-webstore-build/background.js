...
chrome.runtime.onMessage.addListener((msg, sender, sendResponse) => {
  const processMessage = async () => {
    ...
    // Handle dedupe messages
    if (msg.type?.startsWith("DEDUPE_") && typeof globalThis.DedupePipeline?.handleDedupeMessage === "function") {
      try {
        const result = await globalThis.DedupePipeline.handleDedupeMessage(msg, sender);
